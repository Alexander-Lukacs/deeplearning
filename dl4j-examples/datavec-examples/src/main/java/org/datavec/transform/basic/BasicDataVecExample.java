...
public class BasicDataVecExample {
    ...
    private void start() {
        try {
            loadData(defineOperation(buildSchema()));
        }
        catch (Exception e){
    ...
    private TransformProcess defineOperation(Schema inputDataSchema) {
    ...
    private void loadData( TransformProcess tp) throws Exception {
        //=====================================================================
